...
{    /// <summary>
    ...
    "http://d1.web2.qq.com/proxy.html?v=20151105001&callback=1&id=2"
        ...
        public static readonly ApiUrl KickGroupMember = new ApiUrl(
            "http://qun.qq.com/cgi-bin/qun_mgr/delete_group_member",
            "http://qun.qq.com/member.html"
            );

        public static readonly ApiUrl GetGroupInfo2 = new ApiUrl(
    "http://qun.qq.com/cgi-bin/qun_mgr/search_group_members",
    "http://qun.qq.com/member.html"
);
        public static readonly ApiUrl GetGroupList2 = new ApiUrl(
"http://qun.qq.com/cgi-bin/qun_mgr/get_group_list",
"http://qun.qq.com/member.html"
);
        public static readonly ApiUrl GetFriendList2 = new ApiUrl(
     "http://qun.qq.com/cgi-bin/qun_mgr/get_friend_list",
     "http://qun.qq.com/member.html"
 );

        public static readonly ApiUrl SetGroupShutup = new ApiUrl(
"http://qinfo.clt.qq.com/cgi-bin/qun_info/set_group_shutup",
"http://qinfo.clt.qq.com/qinfo_v3/member.html"
);
        public static readonly ApiUrl SetGroupMemberCard = new ApiUrl(
"http://qinfo.clt.qq.com/cgi-bin/qun_info/set_group_card",
"http://qinfo.clt.qq.com/member.html"
);
        public static readonly ApiUrl SetGroupAdmin = new ApiUrl(
"http://qinfo.clt.qq.com/cgi-bin/qun_info/set_group_admin",
"http://qinfo.clt.qq.com/member.html"
);
        public static readonly ApiUrl GroupSign = new ApiUrl(
"http://qiandao.qun.qq.com/cgi-bin/sign",
"http://qiandao.qun.qq.com/index.html?groupUin={1}&appID=100729587"
);
        public static readonly ApiUrl GroupInviteFriend = new ApiUrl(
"http://qun.qq.com/cgi-bin/qun_mgr/add_group_member",
"http://qun.qq.com/member.html"
);
        public static readonly ApiUrl ChangeState = new ApiUrl(
"http://d1.web2.qq.com/channel/change_status2?newstatus={1}&clientid={2}&psessionid={3}&t={4}",
"http://d1.web2.qq.com/proxy.html?v=20151105001&callback=1&id=2"
);
        ...
        public string Origin
            =>
                Url.Substring(0,
                    Url.IndexOf("/",7,StringComparison.Ordinal));
        ...
        public string BuildReferer(params object[] args)
        {
            var i = 1;
            return args.Aggregate(Referer, (current, arg) => current.Replace("{" + i++ + "}", arg.ToString()));
        }
    }
}
