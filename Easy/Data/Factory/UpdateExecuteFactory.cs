...
{
    class UpdateExecuteFactory : SqlExecuteFactoryBase
    {
        public UpdateExecuteFactory(IDataFactory dataFactory, TableMapAttribute tableAttr) 
        ...
        public override object DoSql()
        {
            ...
            throw new Exception("no update sql executed!");
        }
    }
}
